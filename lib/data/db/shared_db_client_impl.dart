...
class SharedDbClientImpl implements DbClient {
  ...
  Future<bool> saveFavoriteCurrencies(String jsonString) async {
    ...
    LogService.printLog('saveFavoriteCurrenciesList succeed is $isSet');
    return isSet;
  }
  ...
  String? loadFavoriteCurrencies() {
    ...
    LogService.printLog('loadFavoriteCurrenciesList succeed is $jsonString');
    return jsonString;
  }
  ...
  Future<bool> removeFavoriteCurrencies() async {
    ...
    LogService.printLog('removeFavoriteCurrenciesList succeed is $isRemoved');
    return isRemoved;
  }
}
